module.exports = {
  // App Settings
  MONGO_URI: process.env.MONGO_URI || 'mongodb://localhost:27017/base',
  TOKEN_SECRET: process.env.TOKEN_SECRET || '54321-67890-09876-54321',

  // OAuth 2.0
  FACEBOOK_SECRET: process.env.FACEBOOK_SECRET || 'd77436992d2a58f963efdf44d544c361',
  FOURSQUARE_SECRET: process.env.FOURSQUARE_SECRET || 'YOUR_FOURSQUARE_CLIENT_SECRET',
  GOOGLE_SECRET: process.env.GOOGLE_SECRET || 'QilesAYdKJZ4UJkbf0Qt8LQh',
